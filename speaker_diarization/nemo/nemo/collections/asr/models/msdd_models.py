...
class EncDecDiarLabelModel(ModelPT, ExportableEncDecModel):
    ...
    def __init__(self, cfg: DictConfig, trainer: Trainer = None):
        ...
        # self.msdd = EncDecDiarLabelModel.from_pretrained(model_name="diar_msdd_telephonic")
        # logging.info("MSDD Model restored locally from {}".format("diar_msdd_telephonic"))
...
class ClusterEmbedding:
    ...
    def run_clustering_diarizer(self, manifest_filepath: str, emb_dir: str):
        ...
        # print("session_scale_mapping_dict-log", session_scale_mapping_dict)
        
        # with open('session_scale_mapping_dict.pkl', 'wb') as f:
        #     pkl.dump(session_scale_mapping_dict, f)
...
class NeuralDiarizer:
    ...
    def diarize(self) -> List[Optional[List[Tuple[DiarizationErrorRate, Dict]]]]:
        ...
        # print("preds_list-log: ", preds_list)
        # print("len-preds_list-log: ", preds_list[0].shape)
    ...
    def get_range_clus_avg_emb(
        ...
        # print("TEMP-LOG: ", _signals.shape, signal_lengths.shape)
        # print("TEMP-LOG: ", _signals, signal_lengths)
    ...
    def diar_infer(
        ...
        # print("signals-log: ", signals.shape)
        # print("temp-log: ", torch.norm(signals[0]-signals[1]))
        # print("self.diar_window_length: ", self.diar_window_length)
        if self._cfg.diarizer.msdd_model.parameters.split_infer:
            ...
            # print("sess_emb_seq-log: ", sess_emb_seq.shape)
            # print("sess_emb_vectors-log: ", sess_emb_vectors.shape)
            # print("sess_sig_lengths-log: ", sess_sig_lengths.shape)
            # print("sess_sig_lengths-log: ", sess_sig_lengths)
        ...
        # print("scale_weights-log: ", scale_weights.shape)
        # print("scale_weights-log: ", scale_weights)
        # torch.save(scale_weights, 'scale_weights.pt')
        # print("_preds-log: ", preds.shape)
        # print("_preds-log: ", targets.shape)
    ...
    def run_pairwise_diarization(self) -> Tuple[List[torch.Tensor], List[torch.Tensor], List[torch.Tensor]]:
        ...
        # print("TEST-LOG: ", self.msdd_model.cfg.test_ds)
        ...
        # print("uniq_id_list-log: ", uniq_id_list)
        ...
        for sidx, test_batch in enumerate(tqdm(self.msdd_model.test_dataloader())):
            signals, signal_lengths, _targets, emb_vectors = test_batch
            # print("LOG: ", signals.shape, signal_lengths.shape, _targets.shape, emb_vectors.shape)
        ...
        # print("uniq_id_list-log: ", uniq_id_list)
        # print("preds_list-log: ", preds_list.shape)
        # print("preds_list-log: ", preds_list)
